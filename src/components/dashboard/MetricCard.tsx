...
export function MetricCard({ 
  ...
  return (
    <Card 
      className={`
        bg-gradient-card border-border/50 shadow-card hover:shadow-hover 
    ...
    >
      ...
      <CardContent>
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-primary/5 via-transparent to-orange/5 opacity-0 group-hover:opacity-100 transition-all duration-500" />
